...
const About = () => {
    return (
        <div id='about' className=' w-full md:flex justify-center bg-neutral-950 gap-2 px-5 text-white h-full'>
            <motion.img initial={{ translateX: -50, opacity: 0 }} transition={{ duration: 1, delay: 0.3 }} whileInView={{ translateX: 0, opacity: 1 }} src={img} alt='' className=' w-[15rem] mx-auto rounded-xl object-contain saturate-50' />
            <motion.div initial={{ translateX: 50, opacity: 0 }} transition={{ duration: 1, delay: 0.3 }} whileInView={{ translateX: 0, opacity: 1 }} className=' md:w-max'>
